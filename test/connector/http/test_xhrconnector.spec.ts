...
it('validate xhrConnector test delete request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
        method: "DELETE",
...
it('validate xhrConnector test get request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
        method: "GET",
...
it('validate xhrConnector test head request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
        method: "HEAD",
...
it('validate xhrConnector test options request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
        method: "OPTIONS",
...
it('validate xhrConnector test get request headers', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
...
it('validate xhrConnector test post request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
...
it('validate xhrConnector test patch request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
...
it('validate xhrConnector test put request', async () => {
    const response = await xhrConnector(Defaults.httpConfig({
...
it('validate xhrConnector test request basic auth', async () => {
    const response1 = await xhrConnector(Defaults.httpConfig({
        url: `http://127.0.0.1:${port}/profile`,
        method: "GET",
        responseType: "json",
        validateStatus: (_) => true,
    }));
    const response2 = await xhrConnector(Defaults.httpConfig({
        url: `http://127.0.0.1:${port}/profile`,
        method: "GET",
        auth: {
    ...
    const response3 = await xhrConnector(Defaults.httpConfig({
        url: `http://127.0.0.1:${port}/profile`,
        method: "GET",
        auth: {
...
it('validate xhrConnector test with MapCacheManager cache', async () => {
    ...
    const response1 = await xhrConnector(config1);
    const response2 = await xhrConnector(config1);
    const response3 = await xhrConnector(config2);
